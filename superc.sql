...
CREATE TABLE `schedule` (
                            `schedule_id` bigint(20) NOT NULL  COMMENT 'ID',
                            `phone` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '手机号',
                            `schedule_time` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '日程绑定时间',
                            `end_time` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '日程最后更新时间',
                            `message` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '日程信息'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='日程表' ROW_FORMAT=DYNAMIC;

INSERT INTO `schedule`(`schedule_id`, `phone`,  `schedule_time`,`end_time`,`message`) VALUES
                                                                                          (1, '15119380977', '2023-02-27', '2023-02-27 22:00', '123456'),
                                                                                          (2, '15119380978', '2023-02-26', '2023-02-27 22:11', '1234567');
...
ALTER TABLE `schedule`
    MODIFY `schedule_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=3;
COMMIT;
